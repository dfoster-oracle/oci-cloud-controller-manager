...
type FileSystem struct {
	...
	// Specifies whether the file system can be used as a target filesystem for replication.
	IsTargetable *bool `mandatory:"false" json:"isTargetable"`

	// The OCID (https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the replication target associated with the filesystem.
	// Empty if the filesystem is not being used as target in a replication.
