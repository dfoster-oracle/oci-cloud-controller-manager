...
var mappingReverseConnectionConfigurationProxyType = map[string]ReverseConnectionConfigurationProxyTypeEnum{
...
func GetReverseConnectionConfigurationProxyTypeEnumValues() []ReverseConnectionConfigurationProxyTypeEnum {
	...
	for _, v := range mappingReverseConnectionConfigurationProxyType {
		values = append(values, v)
	}
	return values
}
