...
type PrivateIp struct {
	...
	LifecycleState PrivateIpLifecycleStateEnum `mandatory:"false" json:"lifecycleState,omitempty"`
}
...
// PrivateIpLifecycleStateEnum Enum with underlying type: string
type PrivateIpLifecycleStateEnum string

// Set of constants representing the allowable values for PrivateIpLifecycleStateEnum
const (
	PrivateIpLifecycleStateProvisioning PrivateIpLifecycleStateEnum = "PROVISIONING"
	PrivateIpLifecycleStateAvailable    PrivateIpLifecycleStateEnum = "AVAILABLE"
	PrivateIpLifecycleStateTerminating  PrivateIpLifecycleStateEnum = "TERMINATING"
	PrivateIpLifecycleStateTerminated   PrivateIpLifecycleStateEnum = "TERMINATED"
)

var mappingPrivateIpLifecycleState = map[string]PrivateIpLifecycleStateEnum{
	"PROVISIONING": PrivateIpLifecycleStateProvisioning,
	"AVAILABLE":    PrivateIpLifecycleStateAvailable,
	"TERMINATING":  PrivateIpLifecycleStateTerminating,
	"TERMINATED":   PrivateIpLifecycleStateTerminated,
}

// GetPrivateIpLifecycleStateEnumValues Enumerates the set of values for PrivateIpLifecycleStateEnum
func GetPrivateIpLifecycleStateEnumValues() []PrivateIpLifecycleStateEnum {
	values := make([]PrivateIpLifecycleStateEnum, 0)
	for _, v := range mappingPrivateIpLifecycleState {
