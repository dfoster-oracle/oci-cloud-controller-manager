...
var mappingListClientVpnUsersSortBy = map[string]ListClientVpnUsersSortByEnum{
...
func GetListClientVpnUsersSortByEnumValues() []ListClientVpnUsersSortByEnum {
	...
	for _, v := range mappingListClientVpnUsersSortBy {
...
var mappingListClientVpnUsersSortOrder = map[string]ListClientVpnUsersSortOrderEnum{
...
func GetListClientVpnUsersSortOrderEnumValues() []ListClientVpnUsersSortOrderEnum {
	...
	for _, v := range mappingListClientVpnUsersSortOrder {
		values = append(values, v)
	}
	return values
}
