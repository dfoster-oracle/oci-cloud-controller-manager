...
var mappingEnableReverseConnectionsDetailsProxyType = map[string]EnableReverseConnectionsDetailsProxyTypeEnum{
...
func GetEnableReverseConnectionsDetailsProxyTypeEnumValues() []EnableReverseConnectionsDetailsProxyTypeEnum {
	...
	for _, v := range mappingEnableReverseConnectionsDetailsProxyType {
