...
replace (
	...
	k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver v0.17.13
	...
	k8s.io/kube-controller-manager => k8s.io/kube-controller-manager v0.17.13
	k8s.io/kube-proxy => k8s.io/kube-proxy v0.17.13
	k8s.io/kube-scheduler => k8s.io/kube-scheduler v0.16.4
	k8s.io/kubectl => k8s.io/kubectl v0.17.13
	k8s.io/kubelet => k8s.io/kubelet v0.17.13
