...
require (
	...
	github.com/kubernetes-csi/external-provisioner v0.0.0-20231226034218-a0677df7e434 // v3.6.3
	github.com/kubernetes-csi/external-resizer v0.0.0-20231226034222-3496c534a661 // v1.9.3
