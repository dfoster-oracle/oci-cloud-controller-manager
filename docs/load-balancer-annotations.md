...
| `oci-load-balancer-subnets`                 | The comma separated list of OCID of the required [subnet][2] to attach the load balancer to. Must be in separate Availability Domains or 1 regional subnet (recommended).                                                                          | Value provided in config file                    |
